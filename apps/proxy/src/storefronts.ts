export const APPLE_STOREFRONTS: readonly string[] = [
  ...
  'hn', 'hr', 'hu', 'id', 'ie', 'il', 'in', 'iq', 'is', 'it',
  'jm', 'jo', 'jp', 'ke', 'kg', 'kh', 'kn', 'kr', 'kw', 'ky',
  'kz', 'la', 'lb', 'lc', 'lk', 'lr', 'lt', 'lu', 'lv', 'ly',
  'ma', 'md', 'mg', 'mk', 'ml', 'mm', 'mn', 'mo', 'mr', 'ms',
  'mt', 'mu', 'mw', 'mx', 'my', 'mz', 'na', 'ne', 'ng', 'ni',
